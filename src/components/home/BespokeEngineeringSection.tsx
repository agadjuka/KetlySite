        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <div className="flex flex-col justify-center order-1">
            <h2 className="text-4xl md:text-6xl font-display font-light tracking-tight mb-6 text-white">
              <span className="block text-amber-200/80 text-3xl md:text-4xl mb-3 font-serif italic">
                Custom Logic.
              </span>
              Bespoke Engineering
            </h2>
            ...
            <div className="relative pl-8 border-l border-neutral-800 mb-12">
              <div className="mb-12">
                <FeatureItemWithLine
                  variant="compact"
          ...
          <div className="order-2 relative h-full min-h-[500px] w-full flex items-center justify-center">
