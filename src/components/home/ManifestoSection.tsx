export function ManifestoSection() {
  return (
    <section className="relative py-16 md:py-20 px-6 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10 manifesto-reveal">
        <div className="mb-4">
        ...
        <h2 className="font-serif text-4xl md:text-6xl lg:text-7xl leading-tight mb-6 text-white/90">
          True luxury is completely <i className="text-amber-100 italic">seamless.</i>
        </h2>
        ...
        <div className="mt-8 h-8 w-[1px] bg-gradient-to-b from-amber-500/50 to-transparent mx-auto" />
      </div>
    </section>
  );
}
