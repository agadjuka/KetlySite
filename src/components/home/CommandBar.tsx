...
export function CommandBar() {
  ...
  return (
    ...
    >
      <div className="h-12 flex items-center px-3 sm:px-4 gap-2 sm:gap-4 bg-[#1a1a1a]/70 command-bar-blur border border-amber-500/15 rounded-full shadow-[0_0_20px_rgba(0,0,0,0.4)] transition-all duration-500 hover:scale-[1.02] hover:border-amber-500/30 min-w-0 max-w-[calc(100vw-2rem)]">
