...
import { Sparkles, Database, ShieldCheck, Coins, TrendingUp, Briefcase, Monitor, AlertTriangle, Rocket, Sliders, Bot, Calendar, Globe, Zap, Shield } from 'lucide-react';
      ...
      <div className="relative z-10 flex-1 min-h-0">
        <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,3fr)_minmax(0,1fr)] gap-4 lg:gap-6 h-full">
          ...
          <div className="flex flex-col gap-4 h-full min-h-0">
            ...
            {/* Карточка: Связаться с нами */}
            <div className="bg-black/40 backdrop-blur-xl border border-white/5 ring-1 ring-white/5 rounded-2xl overflow-hidden flex flex-col p-4 shadow-xl shrink-0">
              <h3 className="text-xs font-medium text-zinc-500 mb-3 uppercase tracking-wider">Связаться с нами</h3>
              <div className="flex gap-2">
                <a
                  href="https://t.me/your_telegram"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 py-2 rounded-lg bg-white/5 border border-white/10 hover:bg-[#229ED9]/10 hover:border-[#229ED9]/30 transition-all duration-300 cursor-pointer flex items-center justify-center group"
                >
                  <svg className="w-5 h-5 text-zinc-400 group-hover:text-[#229ED9] transition-colors duration-300" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.562 8.161c-.18 1.897-.962 6.502-1.359 8.627-.168.9-.5 1.201-.82 1.23-.697.064-1.226-.461-1.901-.903-1.056-.692-1.653-1.123-2.678-1.8-1.185-.781-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.062 3.345-.48.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.751-.244-1.349-.374-1.297-.789.027-.216.324-.437.893-.663 3.498-1.524 5.831-2.529 6.998-3.014 3.332-1.386 4.024-1.627 4.476-1.635.1 0 .32.024.465.139.126.098.16.232.172.325.016.093.036.306.02.472z" />
                  </svg>
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 py-2 rounded-lg bg-white/5 border border-white/10 hover:bg-[#25D366]/10 hover:border-[#25D366]/30 transition-all duration-300 cursor-pointer flex items-center justify-center group"
                >
                  <svg className="w-5 h-5 text-zinc-400 group-hover:text-[#25D366] transition-colors duration-300" viewBox="0 0 24 24" fill="currentColor">
